...
import { ApiResponse, AddressDTO, CreateAddressDTO } from "@/types";
...
export const addressService = {
  ...
  create: async (data: CreateAddressDTO): Promise<ApiResponse<AddressDTO>> => {
  ...
  getDefault: async (): Promise<ApiResponse<AddressDTO>> => {
    const response = await apiClient.get<ApiResponse<AddressDTO>>("/addresses/default");
    return response.data;
  },
};
